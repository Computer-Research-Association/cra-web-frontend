  ...
  return (
    <PrivacyPolicyContainer>
      ...
      <Paragraph>
        <span>제1조(목적)</span>
        <br />
        CRA (Computer Research Association)(이하 "회사"라고 함)는 회사가
        제공하고자 하는 서비스(이하 "회사 서비스")를 이용하는 개인(이하 "이용자"
        또는 "개인")의 정보(이하 "개인정보")를 보호하기 위해, 개인정보보호법,
      ...
      <Paragraph>
        <span>제7조(회사 서비스 제공을 위한 정보)</span>
        <br />
      ...
      <Paragraph>
        <span>제8조(서비스 이용 및 부정 이용 확인을 위한 정보)</span>
        <br />
        ...
        <br />
        1. 필수 수집 정보: 서비스 이용기록 및 쿠키
      </Paragraph>

      <Paragraph>
        <span>제9조(개인정보 수집 방법)</span>
        <br />
      ...
      <Paragraph>
        <span>제11조(개인정보의 보유 및 이용기간)</span>
        <br />
      ...
      <Paragraph>
        <span>제12조(법령에 따른 개인정보의 보유 및 이용기간)</span>
        <br />
      ...
      <Paragraph>
        ...
        <br />
        {'마)'} 영리목적의 광고성 정보를 전송할 목적으로 수신자를 기망하여 회신을
        유도하는 각종 조치
      </Paragraph>

      <Paragraph>
        <span>제17조(아동의 개인정보보호)</span>
        <br />
        1. 회사는 만 14세 미만 아동의 개인정보 보호를 위하여 만 14세 이상의
        이용자에 한하여 회원가입을 허용합니다.
        <br />
        2. 제1항에도 불구하고 회사는 이용자가 만 14세 미만의 아동일 경우에는, 그
      ...
      <Paragraph>
        <span>제18조(개인정보 조회 및 수집동의 철회)</span>
        <br />
      ...
      <Paragraph>
        <span>제19조(개인정보 정보변경 등)</span>
        <br />
        1. 이용자는 회사에게 전조의 방법을 통해 개인정보의 오류에 대한 정정을
        요청할 수 있습니다.
        <br />
      ...
      <Paragraph>
        <span>제25조(개인정보 처리 최소화 및 교육)</span>
        <br />
      ...
      <Paragraph>
        <span>제26조(개인정보 유출 등에 대한 조치)</span>
        <br />
      ...
      <Paragraph>
        <span>제27조(개인정보 유출 등에 대한 조치의 예외)</span>
        <br />
      ...
      <Paragraph>
        <span>
          제29조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)
        </span>
        <br />
